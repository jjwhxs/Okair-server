...
define(function() {
	...
	// 初始化包装类别下拉列表
	var initCityList = function(selId, withAll, value) {
		initSelect(selId, '/logic/baseInfo/sysDict/city', withAll, value);
		
	};
	
	// 初始化包装类别下拉列表
	var initEquityType = function(selId, withAll, value) {
		initSelect(selId, '/logic/baseInfo/sysDict/equityType', withAll, value);
	...
	var initData = function() {
		initCategoryByParentId('#selCategory1', '3', true);
		$('#selCategory1').val(-1);
		
		initCategoryByParentId('#selCategoryEdit1', '3', false);
		
		initCityList('#selCity', true);
		initCityList('#selCityEdit', false);
		initEquityType('#selEquityType', true);
		initEquityType('#selEquityTypeEdit', false);
