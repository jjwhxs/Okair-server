...
define(function() {
	...
	// 初始化包装类别下拉列表
	var initPowerType = function(selId, withAll, value) {
		initSelect(selId, '/logic/baseInfo/sysDict/powerType', withAll, value);
	...
	var initData = function() {
		initCategoryByParentId('#selCategory1', '2', true);
		$('#selCategory1').val(-1);
		
		initCategoryByParentId('#selCategoryEdit1', '2', false);
		
		initPowerType('#selPowerType', true);
		initPowerType('#selPowerTypeEdit', false);
