...
define(['moment'],function( moment) {
	...
	var baseColumns = [
		...
		{field:'price', title:"购置金额（￥）",halign:'center', align:'right',
	...
	var searchButtonClick = function(evt) {
		...
		if(type == 2) { // 资产领用
			buildTable({
				...
				url:'/logic/trans/finance/checkin/list',
				columns: [
			...
			buildTable({
				...
				url:'/logic/trans/finance/checkout/list',
				columns: [
	...
	var transButtonClick = function(evt) {
		...
		$.post(
			baseUrl + '/logic/trans/finance/' + type ,
			{
