...
require(['jquery', 'moment' , 'bootstrapTable', 'bootstrapTableZhCN', 'bootstrapSwitch', 'bootstrapSelect',
		 'logic/model/assets/normalAssetsInitModel.min',
		 'logic/model/assets/normalAssetsEventModel.min'], function($, moment, table, zhcn, btswitch, bSelect, pageInit, pageEvent){
